...
static const char *__doc_gr_lora_sdr_frame_sync = R"doc(<+description of block+>
...
static const char *__doc_gr_lora_sdr_frame_sync_make = R"doc(<+description of block+>
