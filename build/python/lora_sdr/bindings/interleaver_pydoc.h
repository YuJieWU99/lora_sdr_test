...
static const char *__doc_gr_lora_sdr_interleaver = R"doc(<+description of block+>
...
static const char *__doc_gr_lora_sdr_interleaver_make = R"doc(<+description of block+>
