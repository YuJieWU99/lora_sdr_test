...
static const char *__doc_gr_lora_sdr_deinterleaver = R"doc(<+description of block+>
...
static const char *__doc_gr_lora_sdr_deinterleaver_make = R"doc(<+description of block+>
